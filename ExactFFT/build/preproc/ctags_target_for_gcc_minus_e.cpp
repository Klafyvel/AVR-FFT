# 1 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/ExactFFT/ExactFFT.ino"
# 2 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/ExactFFT/ExactFFT.ino" 2
# 3 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/ExactFFT/ExactFFT.ino" 2
  ...
  */
  ...
  for(i=0; i<array_num_bits; ++i){
    ...
    for(j=0;j<n_1;j++) {
      ...
      cj = cos(-2*3.1415926535897932384626433832795*j/n_2);
      sj = sin(-2*3.1415926535897932384626433832795*j/n_2);
  ...
  for(j=1; j<=(half_size>>1); ++j) {
    cj = cos(-3.1415926535897932384626433832795*j/half_size);
    sj = sin(-3.1415926535897932384626433832795*j/half_size);
