# 1 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/Fixed8FFT/Fixed8FFT.ino"
/*
  Fixed8FFT.ino
...
*/
# 9 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/Fixed8FFT/Fixed8FFT.ino" 2
# 10 "/home/klafyvel/Documents/projets/dev/fftduino/first_instructable/Fixed8FFT/Fixed8FFT.ino" 2
...
float modulus(fixed8_t x[], const int size, float frequency) {
  ...
  for(i=0; i<size/2; i++) {
    ...
    x[i] = ((fixed_mul_8_8(ONE_OVER_SQRT_TWO, fixed_add_saturate_8_8(a, b)))>(((a)>(b)?(a):(b)))?(fixed_mul_8_8(ONE_OVER_SQRT_TWO, fixed_add_saturate_8_8(a, b))):(((a)>(b)?(a):(b))));
